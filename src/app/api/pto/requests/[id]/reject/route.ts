 ...
 * Reject a PTO request (admin/manager only)
 */
export async function PUT(
  ...
  try {
    ...
    if (updateError) {
      console.error("Error rejecting PTO request:", updateError);
      return NextResponse.json({ error: "Failed to reject PTO request" }, { status: 500 });
    }
    ...
    console.error("Error in PUT /api/pto/requests/[id]/reject:", error);
